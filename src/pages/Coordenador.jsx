        ...
        <div className="w-full space-y-3">
          ...
          <div className="flex flex-col items-center justify-center p-3 bg-gray-50 rounded-xl border border-gray-200 w-full">
            <div className="flex items-center gap-1.5 text-gray-400 mb-1">
              <IdCard size={15} />
              <span className="text-[10px] font-bold uppercase tracking-wider">Matrícula</span>
            </div>
            <span className="text-base font-mono font-medium text-gray-700">{coordenadorInfo.matricula}</span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center p-3 bg-gray-50 rounded-xl border border-gray-200 w-full">
            <div className="flex items-center gap-1.5 text-gray-400 mb-1">
              <Mail size={15} />
              <span className="text-[10px] font-bold uppercase tracking-wider">E-mail Corporativo</span>
            </div>
            <span className="text-base font-medium text-gray-700 break-all">{coordenadorInfo.email}</span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center p-3 bg-gray-50 rounded-xl border border-gray-200 w-full">
            <div className="flex items-center gap-1.5 text-gray-400 mb-1">
              <Briefcase size={15} />
              <span className="text-[10px] font-bold uppercase tracking-wider">Cargo / Função</span>
            </div>
            <span className="text-base font-medium text-gray-700">{coordenadorInfo.cargo}</span>
          </div>
